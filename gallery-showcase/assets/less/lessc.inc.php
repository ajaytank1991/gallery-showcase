...
class gs_lessc {
    ...
    protected function injectVariables($args) {
        $this->pushEnv();
        $parser = new gs_lessc_parser($this, __METHOD__);
    ...
    protected function makeParser($name) {
        $parser = new gs_lessc_parser($this, $name);
    ...
    protected function newFormatter() {
        $className = "gs_lessc_formatter_lessjs";
        if (!empty($this->formatterName)) {
            if (!is_string($this->formatterName))
                return $this->formatterName;
            $className = "gs_lessc_formatter_$this->formatterName";
        }
...
class gs_lessc_parser {
    ...
    public function __construct($lessc, $sourceName = null) {
        ...
        if (!self::$operatorString) {
            self::$operatorString = '(' . implode('|', array_map(array('gs_lessc', 'preg_quote'), array_keys(self::$precedence))) . ')';

            $commentSingle = gs_lessc::preg_quote(self::$commentSingle);
            $commentMultiLeft = gs_lessc::preg_quote(self::$commentMultiLeft);
            $commentMultiRight = gs_lessc::preg_quote(self::$commentMultiRight);
    ...
    protected function isDirective($dirname, $directives) {
        ...
        $pattern = implode("|", array_map(array("gs_lessc", "preg_quote"), $directives));
    ...
    protected function expressionList(&$exps) {
        ...
        $exps = gs_lessc::compressList($values, ' ');
        return true;
    }
    ...
    public function propertyValue(&$value, $keyName = null) {
        ...
        $value = gs_lessc::compressList($values, ', ');
        return true;
    }
    ...
    protected function openString($end, &$out, $nestingOpen = null, $rejectStrs = null) {
        ...
        $stop = array("'", '"', "@{", $end);
        $stop = array_map(array("gs_lessc", "preg_quote"), $stop);
    ...
    protected function literal($what, $eatWhitespace = null) {
        ...
        if (!isset(self::$literalCache[$what])) {
            self::$literalCache[$what] = gs_lessc::preg_quote($what);
        }
    ...
    protected function to($what, &$out, $until = false, $allowNewline = false) {
        ...
        if (!$this->match('(' . $validChars . '*?)' . gs_lessc::preg_quote($what), $m, !$until))
            return false;
        if ($until)
...
class gs_lessc_formatter_classic {
...
class gs_lessc_formatter_compressed extends gs_lessc_formatter_classic {
...
class gs_lessc_formatter_lessjs extends gs_lessc_formatter_classic {
